...
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
write.csv (arthro_clean2, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_arthropods_clean_Dec 2020.csv", na="", row.names=FALSE)
```
...
# This line saves the data as a .csv in the appropriate folder with a new name
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
write.csv (fungi_clean2, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_fungi_clean_Dec 2020.csv", na="", row.names=FALSE)
```
...
# This line reads the Darwin core occurrence records .txt file that you unzipped from the appropriate folder
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
plant_raw <- read.delim("Data/Dec 2020/GBIF/Raw/Plants/occurrence.txt")
...
# This line saves the data as a .csv in the appropriate folder with a new name
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
write.csv (plant_clean2, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_plants_clean_Dec 2020.csv", na="", row.names=FALSE)
```
...
write.csv (amphibia, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_amphibia_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (mammalia, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_mammalia_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (reptilia, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_reptilia_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves1, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_aves1_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves2, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_aves2_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves3, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_aves3_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves4, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_aves4_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (fish1, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_fish1_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (fish2, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_fish2_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (inverts, file = "Data/Dec 2020/GBIF/Clean Data/GBIF/GBIF_inverts_clean_Dec 2020.csv", na="", row.names=FALSE)
