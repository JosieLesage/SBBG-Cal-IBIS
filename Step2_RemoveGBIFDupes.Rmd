...
arthro_raw <- read.delim("GBIF/Data/Dec 2020/Raw/Arthropods/occurrence.txt")
...
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
write.csv (arthro_clean2, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_arthropods_clean_Dec 2020.csv", na="", row.names=FALSE)
```
...
# This line reads the Darwin core occurrence records .txt file that you unzipped from the appropriate folder
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
fungi_raw <- read.delim("GBIF/Data/Dec 2020/Raw/Fungi/occurrence.txt")
...
# This line saves the data as a .csv in the appropriate folder with a new name
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
write.csv (fungi_clean2, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_fungi_clean_Dec 2020.csv", na="", row.names=FALSE)
```
...
# This line reads the Darwin core occurrence records .txt file that you unzipped from the appropriate folder
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
plant_raw <- read.delim("GBIF/Data/Dec 2020/Raw/Plants/occurrence.txt")
...
# This line saves the data as a .csv in the appropriate folder with a new name
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
write.csv (plant_clean2, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_plants_clean_Dec 2020.csv", na="", row.names=FALSE)
```
...
```{r cut up big files}
amphibia <- read.delim("GBIF/Data/Dec 2020/Raw/Amphibia/occurrence.txt", quote = "")
mammalia <- read.delim("GBIF/Data/Dec 2020/Raw/Mammals/occurrence.txt", quote = "")
reptilia <- read.delim("GBIF/Data/Dec 2020/Raw/Reptiles/occurrence.txt", quote = "")
aves <- read.delim("GBIF/Data/Dec 2020/Raw/Aves/occurrence.txt", quote = "")
fish <- read.delim("GBIF/Data/Dec 2020/Raw/Fish/occurrence.txt", quote = "")
inverts <- read.delim("GBIF/Data/Dec 2020/Raw/Inverts/occurrence.txt", quote = "")
...
write.csv (amphibia, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_amphibia_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (mammalia, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_mammalia_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (reptilia, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_reptilia_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves1, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_aves1_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves2, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_aves2_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves3, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_aves3_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves4, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_aves4_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (fish1, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_fish1_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (fish2, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_fish2_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (inverts, file = "GBIF/Data/Dec 2020/Clean GBIF/Data/GBIF_inverts_clean_Dec 2020.csv", na="", row.names=FALSE)
