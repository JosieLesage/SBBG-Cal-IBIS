...
arthro_raw <- read.delim("Data/Dec 2020/Raw/Arthropods/occurrence.txt")
...
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
write.csv (arthro_clean2, file = "Data/Dec 2020/Clean Data/GBIF_arthropods_clean_Dec 2020.csv", na="", row.names=FALSE)
```
...
# This line reads the Darwin core occurrence records .txt file that you unzipped from the appropriate folder
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
fungi_raw <- read.delim("Data/Dec 2020/Raw/Fungi/occurrence.txt")
...
# This line saves the data as a .csv in the appropriate folder with a new name
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
write.csv (fungi_clean2, file = "Data/Dec 2020/Clean Data/GBIF_fungi_clean_Dec 2020.csv", na="", row.names=FALSE)
```
...
# This line reads the Darwin core occurrence records .txt file that you unzipped from the appropriate folder
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
plant_raw <- read.delim("Data/Dec 2020/Raw/Plants/occurrence.txt")
...
# This line saves the data as a .csv in the appropriate folder with a new name
## **__THIS IS WHERE YOU WOULD CHANGE THE DATE__**
write.csv (plant_clean2, file = "Data/Dec 2020/Clean Data/GBIF_plants_clean_Dec 2020.csv", na="", row.names=FALSE)
```
...
```{r cut up big files}
amphibia <- read.delim("Data/Dec 2020/Raw/Amphibia/occurrence.txt", quote = "")
mammalia <- read.delim("Data/Dec 2020/Raw/Mammals/occurrence.txt", quote = "")
reptilia <- read.delim("Data/Dec 2020/Raw/Reptiles/occurrence.txt", quote = "")
aves <- read.delim("Data/Dec 2020/Raw/Aves/occurrence.txt", quote = "")
fish <- read.delim("Data/Dec 2020/Raw/Fish/occurrence.txt", quote = "")
inverts <- read.delim("Data/Dec 2020/Raw/Inverts/occurrence.txt", quote = "")
...
write.csv (aves1, file = "Data/Dec 2020/Clean Data/GBIF_aves1_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves2, file = "Data/Dec 2020/Clean Data/GBIF_aves2_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves3, file = "Data/Dec 2020/Clean Data/GBIF_aves3_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves4, file = "Data/Dec 2020/Clean Data/GBIF_aves4_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (fish1, file = "Data/Dec 2020/Clean Data/GBIF_fish1_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (fish2, file = "Data/Dec 2020/Clean Data/GBIF_fish2_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (inverts, file = "Data/Dec 2020/Clean Data/GBIF_inverts_clean_Dec 2020.csv", na="", row.names=FALSE)
