...
write.csv (fish, file = "Data/Dec 2020/Clean Data/GBIF_fish_clean_Dec 2020.csv", na="", row.names=FALSE)
...
The "aves" file is probably HUGE, so you should save is as a .zip folder before uploading it. 