...
### Arthropods
Before running this again **CHANGE THE FILE PATH TO THE CORRECT DATE** in the code below -- remember to change "Dec 2020" to whatever the correct date/folder you created at the start is.
...
```{r}
amphibia <- read.delim("Dec 2020/Raw/Amphibia/occurrence.txt")
mammalia <- read.delim("Dec 2020/Raw/Mammals/occurrence.txt")
reptilia <- read.delim("Dec 2020/Raw/Reptiles/occurrence.txt")
aves <- read.delim("Dec 2020/Raw/Aves/occurrence.txt")
fish <- read.delim("Dec 2020/Raw/Fish/occurrence.txt")
inverts <- read.delim("Dec 2020/Raw/Inverts/occurrence.txt")

## **__THIS IS WHERE YOU WOULD CHANGE THE DATES FOR EACH GROUP__**
write.csv (amphibia, file = "Dec 2020/Clean Data/GBIF_amphibia_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (mammalia, file = "Dec 2020/Clean Data/GBIF_mammalia_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (reptilia, file = "Dec 2020/Clean Data/GBIF_reptilia_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (aves, file = "Dec 2020/Clean Data/GBIF_aves_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (fish, file = "Dec 2020/Clean Data/GBIF_reptilia_clean_Dec 2020.csv", na="", row.names=FALSE)
write.csv (inverts, file = "Dec 2020/Clean Data/GBIF_aves_clean_Dec 2020.csv", na="", row.names=FALSE)
...
Also : apparently, after saving these files, you'll want to open them and save them as a .csv UTC-9 format since the raw .csv format doesn't play nice with the upload system. 
