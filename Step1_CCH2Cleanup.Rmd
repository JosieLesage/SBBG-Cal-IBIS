...
cch2term_occdirs <- list.files(occpath)
...
```{r unzip WKTs}
zipfiles <- list.files("Data/Dec 2020/CCH2/WKTs", pattern = "*.zip")

walk(zipfiles, ~ unzip(zipfile = str_c("Data/Dec 2020/CCH2/WKTs/", .x),
                       exdir = str_c("Data/Dec 2020/CCH2/WKTs/Unzipped/", .x),
                       overwrite = TRUE))
```

```{r import WKTs}
occpath <- "Data/Dec 2020/CCH2/WKTs/Unzipped/"
