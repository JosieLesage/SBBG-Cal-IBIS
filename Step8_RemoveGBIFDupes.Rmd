...
inCode <- read.csv ("PaigeFiles/NA_inCodes_updated2020.csv") %>%
...
Cutting the large datasets into smaller pieces makes it easier to upload to symbiota. In the future, we may need to increase the number of slices.
